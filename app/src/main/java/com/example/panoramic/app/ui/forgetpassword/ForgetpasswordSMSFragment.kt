 ...
 * Use the [ForgetpasswordSMSFragment.newInstance] factory method to
...
class ForgetpasswordSMSFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ForgetpasswordSMSFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ForgetpasswordSMSFragment().apply {
