 ...
 * Use the [AnnouncementItemFragment.newInstance] factory method to
...
class AnnouncementItemFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment AnnouncementItemFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            AnnouncementItemFragment().apply {
